...
class WalletControllerTest {
  ...
  void instrument_detail_on_initiative_ok() throws Exception {
    Mockito.when(walletServiceMock.getInstrumentDetailOnInitiatives(ID_WALLET, USER_ID))
            .thenReturn(new InstrumentOnInitiativesDTO(ID_WALLET, MASKED_PAN, BRAND, new ArrayList<>()));
