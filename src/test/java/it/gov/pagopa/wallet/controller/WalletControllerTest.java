...
class WalletControllerTest {
  ...
  void initiativeList() throws Exception {
    ...
    InitiativeDTO initiativeDTO = new InitiativeDTO(
        INITIATIVE_ID, INITIATIVE_ID, WalletConstants.STATUS_NOT_REFUNDABLE,
        null, "TEST_DATE", null, "TEST_AMOUNT", null, null);
    ...
    mvc.perform(
            MockMvcRequestBuilders.get(BASE_URL + INITIATIVE_LIST + USER_ID)
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .accept(MediaType.APPLICATION_JSON_VALUE))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andReturn();
